...
const MapContainer = () => {
  ...
  useEffect(() => {
    ...
    let iwContent =
      '<div style="padding:1.5rem">성원언어심리센터<br><a href="https://map.kakao.com/link/to/성원언어심리센터(위례점),37.472584894923585,127.14290432171676" style="color:blue" target="_blank">길찾기</a></div>';
